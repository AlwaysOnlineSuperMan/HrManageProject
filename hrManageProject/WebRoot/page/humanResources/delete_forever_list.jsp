	...
	<head>
		...
		<script type="text/javascript">
			...
			function doDelete(id) {
				if (confirm("确定删除此档案吗？")) {
				alert(id);
					location.href = "doDeleteForeverList!humanFile.humanId=" + id;
				}
			}
		</script>
	</head>
			...
			<table width="100%" border="1" cellpadding=5 cellspacing=1
				...
				<s:iterator var="user" value="pageModel.resultList" status="vs">
					...
					<tr class="TR_STYLE2">
						...
						<td width="7%" class="TD_STYLE2">
							<img src="/hrManageProject/images/bt_del.gif" title="删除" style="cursor:pointer;" onclick="doDelete('${humanId}')"/>
						</td>
					</tr>
