...
<html>
	...
	<body>
		...
		<s:form action="humanFile!doHumanCheck.action" method="post" enctype="multipart/form-data" >
			<table width="100%">
				<tr>
					<td>
				...
				<tr>
					...
					<td colspan="7" class="TD_STYLE2">
						<textarea name="humanFamilyMembership" rows="4"
							class="TEXTAREA_STYLE1">${humanFamilyMembership}</textarea>
					</td>
				</tr>
				<tr>
					<td class="TD_STYLE1">
					...
					<td colspan="7" class="TD_STYLE2">
						<textarea name="remark" rows="4" class="TEXTAREA_STYLE1">${remark}</textarea>
					</td>
				</tr>
			</table>
