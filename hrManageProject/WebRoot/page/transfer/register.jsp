...
<html>
	<head>
		...
		<link rel="stylesheet"
			href="/hrManageProject/css/table.css" type="text/css"></link>
	...
	<body>
		<form action="register_success.jsp">
				...
				<tr height="21">
					...
					<td class="TD_STYLE2" width="10%">
						<input type="text" name="majorChange.humanId" readonly="readonly"
							value="${humanFileWithBLOBs.humanId}" class="INPUT_STYLE2" />
					...
					<td class="TD_STYLE2" width="10%">
						<input type="text" name="majorChange.humanName"
							value="${humanFileWithBLOBs.humanName}" readonly="readonly"
							class="INPUT_STYLE2">
					</td>
					<td class="TD_STYLE1" width="8%">
					</td>
				...
				<tr>
					...
					<td class="TD_STYLE2">
						<input type="text" name="majorChange.firstKindName"
							value="${humanFileWithBLOBs.firstKindName}" readonly="readonly" value=""
							class="INPUT_STYLE2">
					...
					<td class="TD_STYLE2" width="10%">
						<input type="text" name="majorChange.secondKindName"
							value="${humanFileWithBLOBs.secondKindName}" readonly="readonly" value=""
							class="INPUT_STYLE2" />
					...
					<td class="TD_STYLE2" width="10%">
						<input type="hidden" name="majorChange.thirdKindId" value="1353319077370">
							...
							value="${humanFileWithBLOBs.thirdKindName}" readonly="readonly" 
							class="INPUT_STYLE2"/>
				...
				<tr>
					...
					<td class="TD_STYLE2">
						<input type="text" name="majorChange.majorKindName"
							value="${humanFileWithBLOBs.hunmaMajorName}" readonly="readonly"
					...
					<td class="TD_STYLE2">
						<input type="text" name="majorChange.majorName"
							value="${humanFileWithBLOBs.humanMajorKindName}" readonly="readonly" 
							class="INPUT_STYLE2" />
					...
					<td class="TD_STYLE2">
						<input type="text" name="majorChange.salaryStandardName"
							value="${humanFileWithBLOBs.salaryStandardName}"
					...
					<td class="TD_STYLE2">
						<input type="text" name="majorChange.salarySum"
							value="${humanFileWithBLOBs.salarySum}" readonly="readonly"
							  class="INPUT_STYLE2" />
					</td>
				</tr>
				<tr>
			...
			$("#newFirstKindName").val($('#firstKindId option:selected').jsp());
   ...
   <select style="width:160px" name="majorChange.newFirstKindId" id="firstKindId" size="1" class="SELECT_STYLE2">						
		...
		<input type="hidden" name="majorChange.newFirstKindName" id="newFirstKindName">
			...
			var second= $("#secondKindId");
			var third=$("#thirdKindId");
	 		 third.change(function(){ $("#newThirdKindName").val($('#thirdKindId option:selected').jsp());});
	 		 second.change(function(){
	 		 $("#newSecondKindName").val($('#secondKindId option:selected').jsp());
				...
				<tr>
					...
					<td class="TD_STYLE2">
					  ...
					  <input type="hidden" name="majorChange.newMajorKindName" id="newMajorKindName">
					   <script type="text/javascript"> 
			$(function() {
	 		$('#newMajorId').change(function(){ $("#newMajorName").val($('#newMajorId option:selected').jsp());});
	 		var second=$('#newMajorKindId');
	 		var third=$('#newMajorId');
	 		 second.change(function(){
	 		 $("#newMajorKindName").val($('#newMajorKindId option:selected').jsp());
					...
					<td class="TD_STYLE2">
					  ...
					  $(function() {
					  	...
					  	standardid.change(function(){
					  		standardname.val($('#newSalaryStandardId option:selected').jsp());
