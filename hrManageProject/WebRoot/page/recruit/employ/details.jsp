		...
		<input type="hidden" name="operate" value="doAdopt">
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					...
					<td class="TD_STYLE2"> 
						<input type="text" name="engageResume.passCheckTime" value="2012-11-25" readonly="readonly" class="INPUT_STYLE2">	 
					</td>
				</tr>
				<tr>
					<td class="TD_STYLE1">
				...
				<tr>
					...
					<td class="TD_STYLE2" colspan="7">
						<textarea
							name="engageResume.passPasscomment" id="passPasscomment" class="TEXTAREA_STYLE1" readonly="readonly"
							rows="4" >&#36890;&#36807;</textarea>
					</td>
				</tr>
			</table>
