...
$(function() {
	...
	<body>
		<form action="/HR_Fist/salaryCriterion/salaryCriterionAction!printsalarystandard.action" method="post">
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					...
					<td width="11%" class="TD_STYLE2">
						<s:property value="salaryStandardWithBLOBs.standardName"/>
					</td>
					<td width="11%" class="TD_STYLE1">
						薪酬总额
					</td>
					<td width="17%" class="TD_STYLE2">
						<s:property value="salaryStandardWithBLOBs.salarySum"/>
					</td>
				...
				<tr>
					...
					<td class="TD_STYLE2">
						<s:property value="salaryStandardWithBLOBs.designer"/>
					</td>
					<td class="TD_STYLE1">
						复核人
					</td>
					<td class="TD_STYLE2">
						<s:property value="salaryStandardWithBLOBs.checker"/>
					</td>
					<td class="TD_STYLE1">
						复核时间
					</td>
