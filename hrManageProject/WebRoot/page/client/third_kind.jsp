	...
	<body>
		<form action="../customiz/customizAction!findThirdKind" method="post">
				...
				<tr>
					<td align="right">
						<input type="button" value="添加" class="BUTTON_STYLE1"
							onclick="window.location.href='configFileThirdKind!toThirdKindRegister.action'" />
					</td>
				</tr>
			</table>
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<s:iterator value="configFileThirdKindList" >
						...
						<td class="TD_STYLE2"><s:property value="thirdKindId"/>
						</td>
						<td class="TD_STYLE2"><s:property value="thirdKindName"/>
						</td>
						<td class="TD_STYLE2"><s:property value="thirdKindSaleId"/>
						</td>
						<td class="TD_STYLE2"><s:property value="thirdKindIsRetail"/>
						
						</td>
						<td class="TD_STYLE2">
							<a href="configFileThirdKind!toThirdKindChange.action?configFileThirdKind.ftkId=${ftkId}">变更</a>
						</td>
						<td class="TD_STYLE2">
							<a href="third_delete_success.jsp">删除</a>
						</td>
					</tr>
					</s:iterator>
