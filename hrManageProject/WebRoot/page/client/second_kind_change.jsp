...
<script type="text/javascript">
	...
	<body>
		...
		<form action="configFileSecondKind!doSecondKindChange.action" method="post">
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				class="TABLE_STYLE1">
					<s:hidden name="configFileSecondKindWithBLOBs.fskId" ></s:hidden>
				...
				<tr>
					...
					<s:hidden id="firstKindName" name="configFileSecondKindWithBLOBs.firstKindName"></s:hidden>
					</td>
				</tr>
					<tr>
					<td width="19%" class="TD_STYLE1">
