...
public class HumanFile {
  ...
  /*  public Boolean getHumanFileStatus() {
	...
	public String toString() {
		return "HumanFile [attachmentName=" + attachmentName + ", bonusAmount="
				+ bonusAmount + ", changeTime=" + changeTime + ", changer="
				+ changer + ", checkStatus=" + checkStatus + ", checkTime="
				+ checkTime + ", checker=" + checker + ", deleteTime="
				+ deleteTime + ", demandSalaraySum=" + demandSalaraySum
				+ ", fileChangAmount=" + fileChangAmount + ", firstKindId="
				+ firstKindId + ", firstKindName=" + firstKindName + ", hufId="
				+ hufId + ", humanAccount=" + humanAccount + ", humanAddress="
				+ humanAddress + ", humanAge=" + humanAge + ", humanBank="
				+ humanBank + ", humanBirthday=" + humanBirthday
				...
				+ ", humanEmail=" + humanEmail + ", humanFileStatus="
				+ humanFileStatus + ", humanHobby=" + humanHobby + ", humanId="
				+ humanId + ", humanIdCard=" + humanIdCard + ", humanMajorId="
				+ humanMajorId + ", humanMajorKindId=" + humanMajorKindId
