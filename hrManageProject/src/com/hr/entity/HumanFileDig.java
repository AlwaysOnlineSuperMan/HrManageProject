...
public class HumanFileDig {
    ...
    private Boolean humanFileStatus;
    ...
    public Boolean getHumanFileStatus() {
        return humanFileStatus;
    }

    public void setHumanFileStatus(Boolean humanFileStatus) {
	...
	public String toString() {
		return "HumanFileDig [attachmentName=" + attachmentName
				+ ", bonusAmount=" + bonusAmount + ", changeTime=" + changeTime
				+ ", changer=" + changer + ", checkStatus=" + checkStatus
				+ ", checkTime=" + checkTime + ", checker=" + checker
				+ ", deleteTime=" + deleteTime + ", demandSalaraySum="
				+ demandSalaraySum + ", fileChangAmount=" + fileChangAmount
				+ ", firstKindId=" + firstKindId + ", firstKindName="
				+ firstKindName + ", hfdId=" + hfdId + ", humanAccount="
				+ humanAccount + ", humanAddress=" + humanAddress
				+ ", humanAge=" + humanAge + ", humanBank=" + humanBank
				+ ", humanBirthday=" + humanBirthday + ", humanBirthplace="
				+ humanBirthplace + ", humanEducatedDegree="
				+ humanEducatedDegree + ", humanEducatedMajor="
				+ humanEducatedMajor + ", humanEducatedYears="
				+ humanEducatedYears + ", humanEmail=" + humanEmail
				+ ", humanFileStatus=" + humanFileStatus + ", humanHobby="
				+ humanHobby + ", humanId=" + humanId + ", humanIdCard="
				+ humanIdCard + ", humanMajorId=" + humanMajorId
				+ ", humanMajorKindId=" + humanMajorKindId
				+ ", humanMajorKindName=" + humanMajorKindName
				+ ", humanMobilephone=" + humanMobilephone + ", humanName="
				+ humanName + ", humanNationality=" + humanNationality
				+ ", humanParty=" + humanParty + ", humanPicture="
				+ humanPicture + ", humanPostcode=" + humanPostcode
				+ ", humanProDesignation=" + humanProDesignation + ", humanQq="
				+ humanQq + ", humanRace=" + humanRace + ", humanReligion="
				+ humanReligion + ", humanSex=" + humanSex
				+ ", humanSocietySecurityId=" + humanSocietySecurityId
				+ ", humanSpeciality=" + humanSpeciality + ", humanTelephone="
				+ humanTelephone + ", hunmaMajorName=" + hunmaMajorName
				+ ", lastlyChangeTime=" + lastlyChangeTime
				+ ", majorChangeAmount=" + majorChangeAmount
				+ ", paidSalarySum=" + paidSalarySum + ", recoveryTime="
				+ recoveryTime + ", registTime=" + registTime + ", register="
				+ register + ", salaryStandardId=" + salaryStandardId
				+ ", salaryStandardName=" + salaryStandardName + ", salarySum="
				+ salarySum + ", secondKindId=" + secondKindId
				+ ", secondKindName=" + secondKindName + ", thirdKindId="
				+ thirdKindId + ", thirdKindName=" + thirdKindName
				+ ", trainingAmount=" + trainingAmount + ", updateDatetime="
				+ updateDatetime + "]";
	}
